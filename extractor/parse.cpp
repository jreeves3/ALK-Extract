...
int Cnf_extractor::parse_options (int argc, char ** argv) {
    ...
    commandLineParseOption(argv, argv+argc, "Encoded_ALK_timeout");
    ...
    commandLineParseOption(argv, argv+argc, "BDD_ordering_file");
    commandLineParseOption(argv, argv+argc, "aux_var_file");

    commandLineParseOption(argv, argv+argc, "verification_type");

    commandLineParseOption (argv, argv+argc, "Write_KNF");

    commandLineParseOption (argv, argv+argc, "ver_only_file");
    ...
    findOption (argv, argv+argc, "Encoded_ALK");
    findOption (argv, argv+argc, "second_chance");
    findOption (argv, argv+argc, "grid");
