...
'''
def generate_cnf (knf_input, cnf_output, encoding_type, variable_ordering_type, random_seed, rename, maxSAT_out, bias_change,  occLimit, tempOrdered, get_coverage, temp_order_file, prox_directory):
...
def run(name, args):
    ...
    optlist, args = getopt.getopt(args, "zrmk:c:e:v:s:b:o:t:q:d:")
    ...
    generate_cnf (knf_input, cnf_output, encoding_type, variable_ordering_type, random_seed, rename, maxSAT_out, bias_change, occLimit, tempORDERED, get_coverage, temp_order_file, prox_directory)
